...
TEST(i8, Traits) {
  ...
  static_assert(sus::num::Eq<i8, i8>);
  static_assert(1_i8 == 1_i8);
  static_assert(!(1_i8 == 2_i8));
  static_assert(1_i8 != 2_i8);
  static_assert(!(1_i8 != 1_i8));
  ...
  constexpr std::strong_ordering o = 2_i8 <=> 3_i8;
}
...
TEST(i8, From) {
  static_assert(sus::concepts::from::From<i8, char>);
  static_assert(sus::concepts::from::From<i8, size_t>);
  static_assert(sus::concepts::from::From<i8, int8_t>);
  static_assert(sus::concepts::from::From<i8, int16_t>);
  static_assert(sus::concepts::from::From<i8, int32_t>);
  static_assert(sus::concepts::from::From<i8, int64_t>);
  static_assert(sus::concepts::from::From<i8, uint8_t>);
  static_assert(sus::concepts::from::From<i8, uint16_t>);
  static_assert(sus::concepts::from::From<i8, uint32_t>);
  static_assert(sus::concepts::from::From<i8, uint64_t>);
  ...
  static_assert(sus::concepts::from::From<i8, i8>);
  static_assert(sus::concepts::from::From<i8, i16>);
  static_assert(sus::concepts::from::From<i8, i32>);
  static_assert(sus::concepts::from::From<i8, i64>);
  static_assert(sus::concepts::from::From<i8, isize>);
  static_assert(sus::concepts::from::From<i8, u8>);
  static_assert(sus::concepts::from::From<i8, u16>);
  static_assert(sus::concepts::from::From<i8, u32>);
  static_assert(sus::concepts::from::From<i8, u64>);
  static_assert(sus::concepts::from::From<i8, usize>);
...
TEST(i8, InvokeEverything) {
  ...
  auto s = 3_u8;
  auto a = sus::Array</*TODO: u8*/ uint8_t, sizeof(i8)>::with_default();
