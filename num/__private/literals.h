...
// template, which is what we used to do before moving to `consteval` (see
// commit 531ac278f5b96a63b39332a0b87ef207e0d40575). However that triggers a
// different MSVC bug when used with any unary/binary operator in a templated
// function:
