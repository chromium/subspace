...
// 0 < val < 100_000
/* TODO: u32 */ constexpr sus_always_inline uint32_t less_than_5(uint32_t val) {
...
// 0 < val <= u32::MAX
constexpr sus_always_inline /* TODO: u32 */ uint32_t u32(uint32_t val) {
  auto log = uint32_t{0};
  if (val >= 100'000) {
    val /= 100'000;
    log += 5;
...
constexpr sus_always_inline /* TODO: u32 */ uint32_t i32(int32_t val) {
