...
concept MaxPlusOneInRange = requires {
                              { 0x80000000'00000000_i64 } -> std::same_as<T>;
                            };
static_assert(!MaxPlusOneInRange<i64>);
template <class T>
concept MaxPlusOneInRangeConstruct = requires {
                                       {
                                         T(0x80000000'00000000)
                                         } -> std::same_as<T>;
                                     };
static_assert(!MaxPlusOneInRangeConstruct<i64>);
#endif
...
TEST(i64, From) {
  static_assert(sus::concepts::from::From<i64, char>);
  static_assert(sus::concepts::from::From<i64, size_t>);
  static_assert(sus::concepts::from::From<i64, int8_t>);
  static_assert(sus::concepts::from::From<i64, int16_t>);
  static_assert(sus::concepts::from::From<i64, int32_t>);
  static_assert(sus::concepts::from::From<i64, int64_t>);
  static_assert(sus::concepts::from::From<i64, uint8_t>);
  static_assert(sus::concepts::from::From<i64, uint16_t>);
  static_assert(sus::concepts::from::From<i64, uint32_t>);
  static_assert(sus::concepts::from::From<i64, uint64_t>);
  ...
  static_assert(sus::concepts::from::From<i64, i8>);
  static_assert(sus::concepts::from::From<i64, i16>);
  static_assert(sus::concepts::from::From<i64, i32>);
  static_assert(sus::concepts::from::From<i64, i64>);
  static_assert(sus::concepts::from::From<i64, isize>);
  static_assert(sus::concepts::from::From<i64, u8>);
  static_assert(sus::concepts::from::From<i64, u16>);
  static_assert(sus::concepts::from::From<i64, u32>);
  static_assert(sus::concepts::from::From<i64, u64>);
  static_assert(sus::concepts::from::From<i64, usize>);
...
TEST(i64, InvokeEverything) {
  ...
  auto s = 3_u64;
  auto a = sus::Array</*TODO: u8*/ uint8_t, sizeof(i64)>::with_default();
