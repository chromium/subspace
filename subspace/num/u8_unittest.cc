...
TEST(u8DeathTest, FromOutOfRange) {
  ...
  EXPECT_DEATH(u8::from(ENUM(, int64_t)::MIN), "");
  EXPECT_DEATH(u8::from(ENUM(, int64_t)::MAX), "");
  EXPECT_DEATH(u8::from(ENUM(, uint64_t)::MAX), "");
  EXPECT_DEATH(u8::from(ENUM(class, int64_t)::MIN), "");
  EXPECT_DEATH(u8::from(ENUM(class, int64_t)::MAX), "");
  EXPECT_DEATH(u8::from(ENUM(class, uint64_t)::MAX), "");
