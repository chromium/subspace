...
TEST(i32, FromPrimitive) {
  ...
  static_assert(IsImplicitlyConvertible<int16_t, i32>);
  static_assert(IsImplicitlyConvertible<int32_t, i32>);
  static_assert(NotConvertible<int64_t, i32>);
  static_assert(IsImplicitlyConvertible<uint8_t, i32>);
  static_assert(IsImplicitlyConvertible<uint16_t, i32>);
  static_assert(NotConvertible<uint32_t, i32>);
  static_assert(NotConvertible<uint64_t, i32>);
  static_assert(NotConvertible<size_t, i32>);
  static_assert(sizeof(size_t) >= sizeof(i32));

  static_assert(IsImplicitlyConvertible<ENUM(, int8_t), i32>);
  static_assert(IsImplicitlyConvertible<ENUM(, int16_t), i32>);
  static_assert(IsImplicitlyConvertible<ENUM(, int32_t), i32>);
  static_assert(NotConvertible<ENUM(, int64_t), i32>);
  static_assert(IsImplicitlyConvertible<ENUM(, uint8_t), i32>);
  static_assert(IsImplicitlyConvertible<ENUM(, uint16_t), i32>);
  static_assert(NotConvertible<ENUM(, uint32_t), i32>);
  static_assert(NotConvertible<ENUM(, uint64_t), i32>);
  static_assert(NotConvertible<ENUM(, size_t), i32>);

  static_assert(IsExplicitlyConvertible<ENUM(class, int8_t), i32>);
  static_assert(IsExplicitlyConvertible<ENUM(class, int16_t), i32>);
  static_assert(IsExplicitlyConvertible<ENUM(class, int32_t), i32>);
  static_assert(NotConvertible<ENUM(class, int64_t), i32>);
  static_assert(IsExplicitlyConvertible<ENUM(class, uint8_t), i32>);
  static_assert(IsExplicitlyConvertible<ENUM(class, uint16_t), i32>);
  static_assert(NotConvertible<ENUM(class, uint32_t), i32>);
  static_assert(NotConvertible<ENUM(class, uint64_t), i32>);
  static_assert(NotConvertible<ENUM(class, size_t), i32>);
}
