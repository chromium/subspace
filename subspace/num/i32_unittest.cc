...
TEST(i32, ToPrimitive) {
  ...
  static_assert(IsExplicitlyConvertible<i32, int32_t>);
  static_assert(IsExplicitlyConvertible<i32, int64_t>);
  static_assert(NotConvertible<i32, uint8_t>);
  static_assert(NotConvertible<i32, uint16_t>);
  static_assert(IsExplicitlyConvertible<i32, uint32_t>);
  static_assert(IsExplicitlyConvertible<i32, uint64_t>);
  static_assert(IsExplicitlyConvertible<i32, size_t>);
}
...
TEST(i32, From) {
  ...
  static_assert(sus::construct::From<i32, ENUM(, char)>);
  ...
  static_assert(sus::construct::TryFrom<i32, ENUM(, char)>);
  ...
  static_assert(sus::construct::From<i32, ENUM(class, char)>);
  ...
  static_assert(sus::construct::TryFrom<i32, ENUM(class, char)>);
  ...
  EXPECT_EQ(i32::from(ENUM(, char)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, size_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, int8_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, int16_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, int32_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, int64_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, uint8_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, uint16_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, uint32_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, uint64_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(class, uint64_t)::Z), 2_i32);

  EXPECT_EQ(i32::try_from(ENUM(, char)::Z).unwrap(), 2_i32);
  ...
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, char)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, size_t)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, int8_t)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, int16_t)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, int32_t)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, int64_t)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, uint8_t)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, uint16_t)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, uint32_t)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(, uint64_t)::Z), 2_i32);
  EXPECT_EQ(i32::from_unchecked(unsafe_fn, ENUM(class, uint64_t)::Z), 2_i32);
