...
#define _sus__signed_abs(T, PrimitiveT, UnsignedT)                            \
   ...
   */                                                                         \
  sus_pure constexpr UnsignedT abs_diff(const T& r) const& noexcept {         \
...
#define _sus__signed_add(T, UnsignedT)                                         \
   ...
   */                                                                          \
  sus_pure constexpr Option<T> checked_add_unsigned(const UnsignedT& rhs)      \
      const& noexcept {                                                        \
   ...
   */                                                                          \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>          \
  sus_pure constexpr Tuple overflowing_add_unsigned(const UnsignedT& rhs)      \
      const& noexcept {                                                        \
   ...
   */                                                                          \
  sus_pure constexpr T saturating_add_unsigned(const UnsignedT& rhs)           \
      const& noexcept {                                                        \
    const auto r = __private::add_with_overflow_unsigned(primitive_value,      \
                                                         rhs.primitive_value); \
   ...
   */                                                                          \
  sus_pure inline constexpr T unchecked_add(::sus::marker::UnsafeFnMarker,     \
   ...
   */                                                                          \
  sus_pure constexpr T wrapping_add_unsigned(const UnsignedT& rhs)             \
      const& noexcept {                                                        \
...
#define _sus__signed_mul(T)                                                    \
   ...
   */                                                                          \
  sus_pure constexpr inline T unchecked_mul(::sus::marker::UnsafeFnMarker,     \
                                            const T& rhs) const& noexcept {    \
...
#define _sus__signed_sub(T, PrimitiveT, UnsignedT)                            \
   ...
   * overflow occurred.                                                       \
   */                                                                         \
  sus_pure constexpr Option<T> checked_sub(const T& rhs) const& {             \
    const auto out =                                                          \
   ...
   * returning None if overflow occurred.                                     \
   */                                                                         \
  sus_pure constexpr Option<T> checked_sub_unsigned(const UnsignedT& rhs)     \
      const& {                                                                \
   ...
   */                                                                         \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>         \
  sus_pure constexpr Tuple overflowing_sub_unsigned(const UnsignedT& rhs)     \
      const& noexcept {                                                       \
    const auto out = __private::sub_with_overflow_unsigned(                   \
        primitive_value, rhs.primitive_value);                                \
    return Tuple::with(out.value, out.overflow);                              \
   ...
   */                                                                         \
  sus_pure constexpr T saturating_sub_unsigned(const UnsignedT& rhs) const& { \
    const auto out = __private::sub_with_overflow_unsigned(                   \
        primitive_value, rhs.primitive_value);                                \
    if (!out.overflow) [[likely]]                                             \
      return out.value;                                                       \
   ...
   * cannot occur.                                                            \
   */                                                                         \
  sus_pure inline constexpr T unchecked_sub(::sus::marker::UnsafeFnMarker,    \
                                            const T& rhs) const& {            \
    return static_cast<PrimitiveT>(primitive_value - rhs.primitive_value);    \
  }                                                                           \
                                                                              \
   ...
   */                                                                         \
  sus_pure constexpr T wrapping_sub_unsigned(const UnsignedT& rhs) const& {   \
...
#define _sus__signed_pow(T)                                                    \
  ...
  sus_pure constexpr inline T pow(const u32& rhs) const& noexcept {            \
    const auto out =                                                           \
...
#define _sus__signed_hash_equal_to(Type)                                     \
  ...
  struct equal_to<Type> {                                                    \
    sus_pure constexpr auto operator()(const Type& l, const Type& r) const { \
      return l == r;                                                         \
    }                                                                        \
  };                                                                         \
  static_assert(true)
