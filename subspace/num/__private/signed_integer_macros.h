...
#define _sus__signed_integer_comparison(T, PrimitiveT)                         \
   ...
   * zero or negative.                                                         \
   */                                                                          \
  [[nodiscard]] sus_pure constexpr bool is_negative() const& noexcept {        \
    return primitive_value < 0;                                                \
  }                                                                            \
  /** Returns true if the current value is negative and false if the number is \
   * zero or positive.                                                         \
   */                                                                          \
  [[nodiscard]] sus_pure constexpr bool is_positive() const& noexcept {        \
    return primitive_value > 0;                                                \
  }                                                                            \
                                                                               \
   ...
   */                                                                          \
  [[nodiscard]] sus_pure constexpr T signum() const& noexcept {                \
...
#define _sus__signed_abs(T, PrimitiveT, UnsignedT)                            \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr inline T abs() const& noexcept {           \
    /* TODO: Allow opting out of all overflow checks? */                      \
    ::sus::check(primitive_value != MIN_PRIMITIVE);                           \
    if (primitive_value >= 0)                                                 \
      return primitive_value;                                                 \
   ...
   * value is MIN.                                                            \
   */                                                                         \
  [[nodiscard]] sus_pure constexpr Option<T> checked_abs() const& noexcept {  \
  ...
  [[nodiscard]] sus_pure constexpr Tuple overflowing_abs() const& noexcept {  \
    if (primitive_value != MIN_PRIMITIVE) [[likely]]                          \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr T saturating_abs() const& noexcept {       \
    if (primitive_value != MIN_PRIMITIVE) [[likely]]                          \
      return abs();                                                           \
    else                                                                      \
      return MAX;                                                             \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr UnsignedT unsigned_abs() const& noexcept { \
    if (primitive_value >= 0) {                                               \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr T wrapping_abs() const& noexcept {         \
    if (primitive_value != MIN_PRIMITIVE) [[likely]]                          \
      return abs();                                                           \
    else                                                                      \
      return MIN;                                                             \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr UnsignedT abs_diff(const T& r)             \
      const& noexcept {                                                       \
...
#define _sus__signed_add(T, UnsignedT)                                         \
   ...
   */                                                                          \
  [[nodiscard]] sus_pure constexpr Option<T> checked_add_unsigned(             \
   ...
   */                                                                          \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>          \
  [[nodiscard]] sus_pure constexpr Tuple overflowing_add_unsigned(             \
      const UnsignedT& rhs) const& noexcept {                                  \
   ...
   */                                                                          \
  [[nodiscard]] sus_pure constexpr T saturating_add_unsigned(                  \
      const UnsignedT& rhs) const& noexcept {                                  \
    const auto r = __private::add_with_overflow_unsigned(primitive_value,      \
                                                         rhs.primitive_value); \
   ...
   */                                                                          \
  [[nodiscard]] sus_pure constexpr T wrapping_add_unsigned(                    \
      const UnsignedT& rhs) const& noexcept {                                  \
...
#define _sus__signed_mul(T)                                                    \
   ...
   */                                                                          \
  [[nodiscard]] sus_pure constexpr inline T unchecked_mul(                     \
      ::sus::marker::UnsafeFnMarker, const T& rhs) const& noexcept {           \
...
#define _sus__signed_neg(T)                                                   \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr T saturating_neg() const& noexcept {       \
    if (primitive_value != MIN_PRIMITIVE) [[likely]]                          \
      return __private::unchecked_neg(primitive_value);                       \
    else                                                                      \
      return MAX;                                                             \
...
#define _sus__signed_sub(T, PrimitiveT, UnsignedT)                            \
   ...
   * returning None if overflow occurred.                                     \
   */                                                                         \
  [[nodiscard]] sus_pure constexpr Option<T> checked_sub_unsigned(            \
   ...
   */                                                                         \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>         \
  [[nodiscard]] sus_pure constexpr Tuple overflowing_sub_unsigned(            \
      const UnsignedT& rhs) const& noexcept {                                 \
    const auto out = __private::sub_with_overflow_unsigned(                   \
        primitive_value, rhs.primitive_value);                                \
    return Tuple::with(out.value, out.overflow);                              \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr T saturating_sub_unsigned(                 \
      const UnsignedT& rhs) const& {                                          \
    const auto out = __private::sub_with_overflow_unsigned(                   \
        primitive_value, rhs.primitive_value);                                \
    if (!out.overflow) [[likely]]                                             \
   ...
   * cannot occur.                                                            \
   */                                                                         \
  [[nodiscard]] sus_pure inline constexpr T unchecked_sub(                    \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr T wrapping_sub_unsigned(                   \
      const UnsignedT& rhs) const& {                                          \
...
#define _sus__signed_pow(T)                                                    \
  ...
  [[nodiscard]] sus_pure constexpr inline T pow(const u32& rhs)                \
      const& noexcept {                                                        \
    const auto out =                                                           \
...
#define _sus__signed_log(T)                                                   \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr Option<u32> checked_log2() const& {        \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure constexpr u32 log2() const& {                        \
    /* TODO: Allow opting out of all overflow checks? */                      \
   ...
   * Returns None if the number is negative or zero.                          \
   */                                                                         \
  [[nodiscard]] sus_pure constexpr Option<u32> checked_log10() const& {       \
    if (primitive_value <= 0) [[unlikely]] {                                  \
      return Option<u32>::none();                                             \
    } else {                                                                  \
   ...
   * When the number is zero or negative the function will panic.             \
   */                                                                         \
  [[nodiscard]] sus_pure constexpr u32 log10() const& {                       \
    /* TODO: Allow opting out of all overflow checks? */                      \
...
#define _sus__signed_endian(T, UnsignedT, Bytes)                              \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure static constexpr T from_be(const T& x) noexcept {    \
   ...
   */                                                                         \
  [[nodiscard]] sus_pure static constexpr T from_le(const T& x) noexcept {    \
   ...
   * endian.                                                                  \
   */                                                                         \
  [[nodiscard]] sus_pure static constexpr T from_be_bytes(                    \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept;             \
                                                                              \
  /** Create an integer value from its representation as a byte array in      \
   * little endian.                                                           \
   */                                                                         \
  [[nodiscard]] sus_pure static constexpr T from_le_bytes(                    \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept;             \
                                                                              \
   ...
   * instead.                                                                 \
   */                                                                         \
  [[nodiscard]] sus_pure static constexpr T from_ne_bytes(                    \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept;             \
  static_assert(true)
  ...
  T::to_ne_bytes() const& noexcept {                                          \
    ...
    if (std::is_constant_evaluated()) {                                       \
      ...
      return bytes;                                                           \
                                                                              ...
                                                                              \
  [[nodiscard]] sus_pure inline constexpr T T::from_be_bytes(                 \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept {            \
    return from_be(from_ne_bytes(bytes));                                     \
  }                                                                           \
                                                                              \
  [[nodiscard]] sus_pure inline constexpr T T::from_le_bytes(                 \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept {            \
    return from_le(from_ne_bytes(bytes));                                     \
  }                                                                           \
                                                                              \
  [[nodiscard]] sus_pure inline constexpr T T::from_ne_bytes(                 \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept {            \
...
#define _sus__signed_hash_equal_to(Type)                                    \
  template <>                                                               \
  struct hash<Type> {                                                       \
    [[nodiscard]] sus_pure size_t operator()(const Type& u) const {         \
      return u.primitive_value;                                             \
    }                                                                       \
  };                                                                        \
  template <>                                                               \
  struct equal_to<Type> {                                                   \
    [[nodiscard]] sus_pure constexpr auto operator()(const Type& l,         \
                                                     const Type& r) const { \
      return l == r;                                                        \
    }                                                                       \
  };                                                                        \
