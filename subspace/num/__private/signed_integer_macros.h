...
#define _sus__signed_construct(T, PrimitiveT)                                  \
   ...
   */                                                                          \
  template <Signed S>                                                          \
    requires(::sus::mem::size_of<S>() <= ::sus::mem::size_of<PrimitiveT>())    \
  constexpr inline T(S v) noexcept : primitive_value(v.primitive_value) {}     \
                                                                               \
  ...
  consteval inline T(S v) noexcept                                             \
    ...
    /* SAFETY: P has more bits than T, so converting a signed T to P will fit. \
     */                                                                        \
    if (v > static_cast<decltype(S::primitive_value)>(T::MAX_PRIMITIVE)) {     \
      ::sus::panic_with_message(                                             \
            *"Cannot construct signed integer from value outside its "       \
             "range."); \
    }                                                                          \
  }                                                                            \
                                                                               \
  ...
  explicit constexpr inline T(P v) noexcept                                    \
      : primitive_value(static_cast<PrimitiveT>(v)) {}                         \
                                                                               \
  /** Construction from signed enum types, where it can be checked at compile  \
   * time that no bits are lost.                                               \
   *                                                                           \
   * For runtime conversion, use `from()`.                                     \
   *                                                                           \
   * #[doc.overloads=ctor.signed.signedenum]                                   \
   */                                                                          \
  template <SignedPrimitiveEnum P>                                             \
    requires(::sus::mem::size_of<P>() > ::sus::mem::size_of<PrimitiveT>())     \
  consteval inline T(P v) noexcept                                             \
    ...
    if (u > static_cast<std::underlying_type_t<P>>(T::MAX_PRIMITIVE) ||        \
        u < static_cast<std::underlying_type_t<P>>(T::MIN_PRIMITIVE)) {        \
      ::sus::panic_with_message(                                               \
          *"Cannot construct signed integer from value outside its range.");   \
    }                                                                          \
  }                                                                            \
                                                                               \
  /** Construction from signed enum types, where it can be checked at compile  \
   ...
   * For runtime conversion, use `from()`.                                     \
   *                                                                           \
   * #[doc.overloads=ctor.signed.signedenumclass]                              \
   */                                                                          \
  template <SignedPrimitiveEnumClass P>                                        \
    requires(::sus::mem::size_of<P>() > ::sus::mem::size_of<PrimitiveT>())     \
   ...
   *                                                                           \
   * #[doc.overloads=signedint.ctor.unsigned.large.typed]                      \
   */                                                                          \
  template <Unsigned U>                                                        \
    requires(::sus::mem::size_of<U>() >= ::sus::mem::size_of<PrimitiveT>())    \
  consteval inline T(U v) noexcept                                             \
    ...
    if (v > static_cast<decltype(U::primitive_value)>(T::MAX_PRIMITIVE)) {     \
      ::sus::panic_with_message(                                               \
          *"Cannot assign to signed integer from value outside its range.");   \
    }                                                                          \
  }                                                                            \
                                                                               \
   ...
   * For runtime conversion of larger values, use `from()`.                    \
   *                                                                           \
   * #[doc.overloads=signedint.ctor.unsigned.large.primitive]                  \
   */                                                                          \
  template <UnsignedPrimitiveInteger P>                                        \
    requires(::sus::mem::size_of<P>() >= ::sus::mem::size_of<PrimitiveT>())    \
  consteval inline T(P v) noexcept                                             \
      : primitive_value(/* SAFETY: We check below that v <= T::MAX, so we can  \
                         * cast `v` to a `T`. */                               \
                        static_cast<PrimitiveT>(v)) {                          \
    /* SAFETY: The unsigned P is non-negative, as is T::MAX_PRIMITIVE, so      \
     * the sign bit isn't used. If they are the same size, P has more bits     \
     * than T after removing the sign bit. Otherwise, P is larger and also has \
     * more bits than T. Thus it is safe to convert T to P without losing      \
     * data. */                                                                \
    if (v > static_cast<P>(T::MAX_PRIMITIVE)) {                                \
      ::sus::panic_with_message(                                               \
          *"Cannot assign to signed integer from value outside its range.");   \
   ...
   * For runtime conversion, use `from()`.                                     \
   *                                                                           \
   * #[doc.overloads=ctor.signed.unsignedenum]                                 \
   */                                                                          \
  template <UnsignedPrimitiveEnum P>                                           \
    requires(::sus::mem::size_of<P>() >= ::sus::mem::size_of<PrimitiveT>())    \
  consteval inline T(P v) noexcept                                             \
   ...
   * For runtime conversion, use `from()`.                                     \
   *                                                                           \
   * #[doc.overloads=ctor.signed.unsignedenumclass]                            \
   */                                                                          \
  template <UnsignedPrimitiveEnumClass P>                                      \
    requires(::sus::mem::size_of<P>() >= ::sus::mem::size_of<PrimitiveT>())    \
  explicit consteval inline T(P v) noexcept                                    \
  ...
  template <Signed S>                                                          \
    requires(::sus::mem::size_of<S>() <= ::sus::mem::size_of<PrimitiveT>())    \
  constexpr inline T& operator=(S v) noexcept {                                \
  ...
  constexpr inline T& operator=(P v) noexcept {                                \
    ...
    return *this;                                                              \
                                                                               ...
                                                                               \
  /** Assignment from signed enum types, where it can be checked at compile    \
   * time that no bits are lost.                                               \
   *                                                                           \
   * For runtime conversion, use `from()`.                                     \
   *                                                                           \
  ...
  consteval inline T& operator=(P v) noexcept {                                \
     ...
     */                                                                        \
    primitive_value = static_cast<PrimitiveT>(u);                              \
    return *this;                                                              \
  }                                                                            \
                                                                               \
  /** Assignment from unsigned types where no bits are lost.                   \
   *                                                                           \
   * #[doc.overloads=signedint.assign.unsignedint.typed]                       \
   */                                                                          \
  template <Unsigned U>                                                        \
    requires(::sus::mem::size_of<U>() < ::sus::mem::size_of<PrimitiveT>())     \
   ...
   *                                                                           \
   * #[doc.overloads=signedint.assign.unsignedint.primitive]                   \
   */                                                                          \
  template <UnsignedPrimitiveInteger P>                                        \
    requires(::sus::mem::size_of<P>() < ::sus::mem::size_of<PrimitiveT>())     \
  constexpr inline T& operator=(P v) noexcept {                                \
   ...
   * For runtime conversion of larger values, use `from()`.                    \
   *                                                                           \
   * #[doc.overloads=signedint.assign.unsigned.large.typed]                    \
   */                                                                          \
  template <Unsigned U>                                                        \
    requires(::sus::mem::size_of<U>() >= ::sus::mem::size_of<PrimitiveT>())    \
   ...
   * For runtime conversion of larger values, use `from()`.                    \
   *                                                                           \
   * #[doc.overloads=signedint.assign.unsigned.large.primitive]                \
   */                                                                          \
  template <UnsignedPrimitiveInteger P>                                        \
    requires(::sus::mem::size_of<P>() >= ::sus::mem::size_of<PrimitiveT>())    \
  consteval inline T& operator=(P v) noexcept {                                \
   ...
   *                                                                           \
   * #[doc.overloads=signedint.assign.unsignedenum.small]                      \
   */                                                                          \
  template <UnsignedPrimitiveEnum P>                                           \
    requires(::sus::mem::size_of<P>() < ::sus::mem::size_of<PrimitiveT>())     \
  constexpr inline T& operator=(P v) noexcept {                                \
   ...
   * For runtime conversion, use `from()`.                                     \
   *                                                                           \
   * #[doc.overloads=signeding.assign.unsignedenum.large]                      \
   */                                                                          \
  template <UnsignedPrimitiveEnum P>                                           \
    requires(::sus::mem::size_of<P>() >= ::sus::mem::size_of<PrimitiveT>())    \
  consteval inline T& operator=(P v) noexcept {                                \
...
#define _sus__signed_from(T, PrimitiveT)                                       \
   ...
   */                                                                          \
  template <Signed S>                                                          \
  sus_pure static constexpr ::sus::result::Result<               \
   ...
   */                                                                          \
  template <Integer I>                                                         \
  sus_pure static constexpr T from_unchecked(                    \
...
#define _sus__signed_to_primitive(T, PrimitiveT)                            \
  ...
  template <UnsignedPrimitiveInteger U>                                     \
    requires(::sus::mem::size_of<U>() >= ::sus::mem::size_of<PrimitiveT>()) \
  sus_pure constexpr inline explicit operator U() const {     \
    return static_cast<U>(primitive_value);                                 \
  }                                                                         \
  static_assert(true)
...
#define _sus__signed_integer_comparison(T, PrimitiveT)                         \
   ...
   */                                                                          \
  sus_pure constexpr T signum() const& noexcept {                \
  ...
  template <Signed S>                                                          \
  [[nodiscard]] friend sus_pure constexpr inline std::strong_ordering          \
  operator<=>(const T& l, const S& r) noexcept {                               \
    return l.primitive_value <=> r.primitive_value;                            \
  }                                                                            \
  static_assert(true)
...
#define _sus__signed_abs(T, PrimitiveT, UnsignedT)                            \
   ...
   */                                                                         \
  sus_pure constexpr inline T abs() const& noexcept {           \
    /* TODO: Allow opting out of all overflow checks? */                      \
    ::sus::check(primitive_value != MIN_PRIMITIVE);                           \
    if (primitive_value >= 0)                                                 \
      return primitive_value;                                                 \
   ...
   * value is MIN.                                                            \
   */                                                                         \
  sus_pure constexpr Option<T> checked_abs() const& noexcept {  \
   ...
   */                                                                         \
  sus_pure constexpr T saturating_abs() const& noexcept {       \
    if (primitive_value != MIN_PRIMITIVE) [[likely]]                          \
      return abs();                                                           \
    else                                                                      \
      return MAX;                                                             \
   ...
   */                                                                         \
  sus_pure constexpr UnsignedT unsigned_abs() const& noexcept { \
    if (primitive_value >= 0) {                                               \
   ...
   */                                                                         \
  sus_pure constexpr T wrapping_abs() const& noexcept {         \
    if (primitive_value != MIN_PRIMITIVE) [[likely]]                          \
      return abs();                                                           \
    else                                                                      \
      return MIN;                                                             \
   ...
   */                                                                         \
  sus_pure constexpr UnsignedT abs_diff(const T& r)             \
      const& noexcept {                                                       \
...
#define _sus__signed_add(T, UnsignedT)                                         \
   ...
   * overflow occurred.                                                        \
   */                                                                          \
  sus_pure constexpr Option<T> checked_add(const T& rhs)         \
      const& noexcept {                                                        \
    const auto out =                                                           \
   ...
   */                                                                          \
  sus_pure constexpr Option<T> checked_add_unsigned(             \
      const UnsignedT& rhs) const& noexcept {                                  \
   ...
   */                                                                          \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>          \
  sus_pure constexpr Tuple overflowing_add(const T& rhs)         \
      const& noexcept {                                                        \
    const auto r =                                                             \
        __private::add_with_overflow(primitive_value, rhs.primitive_value);    \
   ...
   */                                                                          \
  sus_pure constexpr T saturating_add(const T& rhs)              \
      const& noexcept {                                                        \
   ...
   */                                                                          \
  sus_pure constexpr T saturating_add_unsigned(                  \
      const UnsignedT& rhs) const& noexcept {                                  \
    const auto r = __private::add_with_overflow_unsigned(primitive_value,      \
                                                         rhs.primitive_value); \
   ...
   */                                                                          \
  sus_pure inline constexpr T unchecked_add(                     \
   ...
   */                                                                          \
  sus_pure constexpr T wrapping_add(const T& rhs)                \
      const& noexcept {                                                        \
   ...
   */                                                                          \
  sus_pure constexpr T wrapping_add_unsigned(                    \
      const UnsignedT& rhs) const& noexcept {                                  \
...
#define _sus__signed_div(T)                                                    \
   ...
   */                                                                          \
  sus_pure constexpr Option<T> checked_div(const T& rhs)         \
      const& noexcept {                                                        \
   ...
   */                                                                          \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>          \
  sus_pure constexpr Tuple overflowing_div(const T& rhs)         \
      const& noexcept {                                                        \
    /* TODO: Allow opting out of all overflow checks? */                       \
   ...
   * This function will panic if rhs is 0.                                     \
   */                                                                          \
  sus_pure constexpr T saturating_div(const T& rhs)              \
      const& noexcept {                                                        \
    /* TODO: Allow opting out of all overflow checks? */                       \
    ::sus::check(rhs.primitive_value != 0);                                    \
    if (__private::div_overflows_nonzero(                                      \
   ...
   * This function will panic if rhs is 0.                                     \
   */                                                                          \
  sus_pure constexpr T wrapping_div(const T& rhs)                \
      const& noexcept {                                                        \
    /* TODO: Allow opting out of all overflow checks? */                       \
    ::sus::check(rhs.primitive_value != 0);                                    \
    if (__private::div_overflows_nonzero(                                      \
...
#define _sus__signed_mul(T)                                                    \
   ...
   * overflow occurred.                                                        \
   */                                                                          \
  sus_pure constexpr Option<T> checked_mul(const T& rhs)         \
      const& noexcept {                                                        \
    const auto out =                                                           \
   ...
   */                                                                          \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>          \
  sus_pure constexpr Tuple overflowing_mul(const T& rhs)         \
      const& noexcept {                                                        \
    const auto out =                                                           \
        __private::mul_with_overflow(primitive_value, rhs.primitive_value);    \
   ...
   */                                                                          \
  sus_pure constexpr T saturating_mul(const T& rhs)              \
      const& noexcept {                                                        \
   ...
   */                                                                          \
  sus_pure constexpr inline T unchecked_mul(                     \
      ::sus::marker::UnsafeFnMarker, const T& rhs) const& noexcept {           \
   ...
   */                                                                          \
  sus_pure constexpr T wrapping_mul(const T& rhs)                \
      const& noexcept {                                                        \
...
#define _sus__signed_neg(T)                                                   \
   ...
   */                                                                         \
  sus_pure constexpr T saturating_neg() const& noexcept {       \
    if (primitive_value != MIN_PRIMITIVE) [[likely]]                          \
      return __private::unchecked_neg(primitive_value);                       \
    else                                                                      \
      return MAX;                                                             \
...
#define _sus__signed_rem(T, PrimitiveT)                                        \
   ...
   * 0 or the division results in overflow.                                    \
   */                                                                          \
  sus_pure constexpr Option<T> checked_rem(const T& rhs)         \
      const& noexcept {                                                        \
    if (__private::div_overflows(primitive_value, rhs.primitive_value))        \
        [[unlikely]]                                                           \
      return Option<T>::none();                                                \
   ...
   */                                                                          \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>          \
  sus_pure constexpr Tuple overflowing_rem(const T& rhs)         \
      const& noexcept {                                                        \
    /* TODO: Allow opting out of all overflow checks? */                       \
    ::sus::check(rhs.primitive_value != 0);                                    \
    if (__private::div_overflows_nonzero(                                      \
   ...
   */                                                                          \
  sus_pure constexpr T wrapping_rem(const T& rhs)                \
      const& noexcept {                                                        \
    /* TODO: Allow opting out of all overflow checks? */                       \
    ::sus::check(rhs.primitive_value != 0);                                    \
    if (__private::div_overflows_nonzero(                                      \
...
#define _sus__signed_euclid(T, PrimitiveT)                                     \
   ...
   */                                                                          \
  sus_pure constexpr T div_euclid(const T& rhs)                  \
      const& noexcept {                                                        \
    /* TODO: Allow opting out of all overflow checks? */                       \
    ::sus::check(                                                              \
   ...
   * This function will panic if rhs is 0.                                     \
   */                                                                          \
  sus_pure constexpr T wrapping_div_euclid(const T& rhs)         \
      const& noexcept {                                                        \
    /* TODO: Allow opting out of all overflow checks? */                       \
    ::sus::check(rhs.primitive_value != 0);                                    \
    if (__private::div_overflows_nonzero(                                      \
   ...
   * This function will panic if rhs is 0 or the division results in overflow. \
   */                                                                          \
  sus_pure constexpr T rem_euclid(const T& rhs)                  \
      const& noexcept {                                                        \
    /* TODO: Allow opting out of all overflow checks? */                       \
    ::sus::check(                                                              \
        !__private::div_overflows(primitive_value, rhs.primitive_value));      \
   ...
   * This function will panic if rhs is 0.                                     \
   */                                                                          \
  sus_pure constexpr T wrapping_rem_euclid(const T& rhs)         \
      const& noexcept {                                                        \
    /* TODO: Allow opting out of all overflow checks? */                       \
    ::sus::check(rhs.primitive_value != 0);                                    \
    if (__private::div_overflows_nonzero(                                      \
...
#define _sus__signed_shift(T)                                                  \
   ...
   */                                                                          \
  sus_pure constexpr Option<T> checked_shl(const u32& rhs)       \
      const& noexcept {                                                        \
    const auto out =                                                           \
   ...
   */                                                                          \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>          \
  sus_pure constexpr Tuple overflowing_shl(const u32& rhs)       \
      const& noexcept {                                                        \
    const auto out =                                                           \
        __private::shl_with_overflow(primitive_value, rhs.primitive_value);    \
    return Tuple::with(out.value, out.overflow);                               \
   ...
   * want instead.                                                             \
   */                                                                          \
  sus_pure constexpr T wrapping_shl(const u32& rhs)              \
      const& noexcept {                                                        \
   ...
   * larger than or equal to the number of bits in self.                       \
   */                                                                          \
  sus_pure constexpr Option<T> checked_shr(const u32& rhs)       \
      const& noexcept {                                                        \
    const auto out =                                                           \
   ...
   */                                                                          \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>          \
  sus_pure constexpr Tuple overflowing_shr(const u32& rhs)       \
      const& noexcept {                                                        \
    const auto out =                                                           \
        __private::shr_with_overflow(primitive_value, rhs.primitive_value);    \
    return Tuple::with(out.value, out.overflow);                               \
   ...
   * you want instead.                                                         \
   */                                                                          \
  sus_pure constexpr T wrapping_shr(const u32& rhs)              \
      const& noexcept {                                                        \
...
#define _sus__signed_sub(T, PrimitiveT, UnsignedT)                            \
   ...
   * overflow occurred.                                                       \
   */                                                                         \
  sus_pure constexpr Option<T> checked_sub(const T& rhs)        \
      const& {                                                                \
    const auto out =                                                          \
   ...
   * returning None if overflow occurred.                                     \
   */                                                                         \
  sus_pure constexpr Option<T> checked_sub_unsigned(            \
      const UnsignedT& rhs) const& {                                          \
   ...
   */                                                                         \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>         \
  sus_pure constexpr Tuple overflowing_sub(const T& rhs)        \
      const& noexcept {                                                       \
    const auto out =                                                          \
        __private::sub_with_overflow(primitive_value, rhs.primitive_value);   \
    return Tuple::with(out.value, out.overflow);                              \
   ...
   * numeric bounds instead of overflowing.                                   \
   */                                                                         \
  sus_pure constexpr T saturating_sub(const T& rhs) const& {    \
   ...
   */                                                                         \
  sus_pure constexpr T saturating_sub_unsigned(                 \
      const UnsignedT& rhs) const& {                                          \
    const auto out = __private::sub_with_overflow_unsigned(                   \
        primitive_value, rhs.primitive_value);                                \
    if (!out.overflow) [[likely]]                                             \
   ...
   * cannot occur.                                                            \
   */                                                                         \
  sus_pure inline constexpr T unchecked_sub(                    \
      ::sus::marker::UnsafeFnMarker, const T& rhs) const& {                   \
    return static_cast<PrimitiveT>(primitive_value - rhs.primitive_value);    \
  }                                                                           \
                                                                              \
   ...
   */                                                                         \
  sus_pure constexpr T wrapping_sub_unsigned(                   \
      const UnsignedT& rhs) const& {                                          \
...
#define _sus__signed_bits(T)                                                   \
   ...
   */                                                                          \
  sus_pure constexpr T rotate_left(const u32& n)                 \
      const& noexcept {                                                        \
   ...
   * Please note this isn't the same operation as the >> shifting operator!    \
   */                                                                          \
  sus_pure constexpr T rotate_right(const u32& n)                \
      const& noexcept {                                                        \
...
#define _sus__signed_pow(T)                                                    \
  ...
  sus_pure constexpr inline T pow(const u32& rhs)                \
      const& noexcept {                                                        \
    const auto out =                                                           \
   ...
   * overflow occurred.                                                        \
   */                                                                          \
  sus_pure constexpr Option<T> checked_pow(const u32& rhs)       \
      const& noexcept {                                                        \
    const auto out =                                                           \
        __private::pow_with_overflow(primitive_value, rhs.primitive_value);    \
    /* TODO: Allow opting out of all overflow checks? */                       \
   ...
   */                                                                          \
  template <int&..., class Tuple = ::sus::tuple_type::Tuple<T, bool>>          \
  sus_pure constexpr Tuple overflowing_pow(const u32& exp)       \
      const& noexcept {                                                        \
    const auto out =                                                           \
   ...
   * around at the boundary of the type.                                       \
   */                                                                          \
  sus_pure constexpr T wrapping_pow(const u32& exp)              \
      const& noexcept {                                                        \
...
#define _sus__signed_log(T)                                                   \
   ...
   */                                                                         \
  sus_pure constexpr Option<u32> checked_log(const T& base)     \
      const& noexcept {                                                       \
...
#define _sus__signed_endian(T, UnsignedT, Bytes)                              \
   ...
   */                                                                         \
  sus_pure static constexpr T from_be(const T& x) noexcept {    \
   ...
   */                                                                         \
  sus_pure static constexpr T from_le(const T& x) noexcept {    \
   ...
   */                                                                         \
  sus_pure constexpr ::sus::containers::Array<u8, Bytes>        \
   ...
   * endian.                                                                  \
   */                                                                         \
  sus_pure static constexpr T from_be_bytes(                    \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept;             \
                                                                              \
  /** Create an integer value from its representation as a byte array in      \
   * little endian.                                                           \
   */                                                                         \
  sus_pure static constexpr T from_le_bytes(                    \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept;             \
                                                                              \
   ...
   * instead.                                                                 \
   */                                                                         \
  sus_pure static constexpr T from_ne_bytes(                    \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept;             \
  static_assert(true)
  ...
  T::to_ne_bytes() const& noexcept {                                          \
    ...
    if (std::is_constant_evaluated()) {                                       \
      ...
      return bytes;                                                           \
                                                                              ...
                                                                              \
  sus_pure inline constexpr T T::from_be_bytes(                 \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept {            \
    return from_be(from_ne_bytes(bytes));                                     \
  }                                                                           \
                                                                              \
  sus_pure inline constexpr T T::from_le_bytes(                 \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept {            \
    return from_le(from_ne_bytes(bytes));                                     \
  }                                                                           \
                                                                              \
  sus_pure inline constexpr T T::from_ne_bytes(                 \
      const ::sus::containers::Array<u8, Bytes>& bytes) noexcept {            \
...
#define _sus__signed_hash_equal_to(Type)                                    \
  template <>                                                               \
  struct hash<Type> {                                                       \
    sus_pure size_t operator()(const Type& u) const {         \
