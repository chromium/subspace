...
TEST(i8, FromPrimitive) {
  ...
  static_assert(IsImplicitlyConvertible<ENUM(, int8_t), i8>);
  static_assert(NotConvertible<ENUM(, int16_t), i8>);
  static_assert(NotConvertible<ENUM(, int32_t), i8>);
  static_assert(NotConvertible<ENUM(, int64_t), i8>);
  static_assert(NotConvertible<ENUM(, uint8_t), i8>);
  static_assert(NotConvertible<ENUM(, uint16_t), i8>);
  static_assert(NotConvertible<ENUM(, uint32_t), i8>);
  static_assert(NotConvertible<ENUM(, uint64_t), i8>);
  static_assert(NotConvertible<ENUM(, size_t), i8>);

  static_assert(IsExplicitlyConvertible<ENUM(class, int8_t), i8>);
  static_assert(NotConvertible<ENUM(class, int16_t), i8>);
  static_assert(NotConvertible<ENUM(class, int32_t), i8>);
  static_assert(NotConvertible<ENUM(class, int64_t), i8>);
  static_assert(NotConvertible<ENUM(class, uint8_t), i8>);
  static_assert(NotConvertible<ENUM(class, uint16_t), i8>);
  static_assert(NotConvertible<ENUM(class, uint32_t), i8>);
  static_assert(NotConvertible<ENUM(class, uint64_t), i8>);
  static_assert(NotConvertible<ENUM(class, size_t), i8>);
}
...
TEST(i8DeathTest, FromOutOfRange) {
  ...
  EXPECT_DEATH(i8::from(ENUM(, int64_t)::MIN), "");
  EXPECT_DEATH(i8::from(ENUM(, int64_t)::MAX), "");
  EXPECT_DEATH(i8::from(ENUM(, uint64_t)::MAX), "");
  EXPECT_DEATH(i8::from(ENUM(class, int64_t)::MIN), "");
  EXPECT_DEATH(i8::from(ENUM(class, int64_t)::MAX), "");
  EXPECT_DEATH(i8::from(ENUM(class, uint64_t)::MAX), "");
