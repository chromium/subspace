...
#include "subspace/containers/compat_unordered_map.h"
...
// For any `usize`.
static_assert(sus::iter::FromIterator<std::unordered_map<usize, usize>,
                                      std::tuple<usize, usize>>);

TEST(CompatUnorderedMap, FromIterator) {
  auto in =
