...
static_assert(sus::mem::Copy<i32>);
static_assert(sus::mem::TrivialCopy<i32>);
static_assert(sus::mem::Clone<i32>);
static_assert(sus::mem::relocate_by_memcpy<i32>);
static_assert(sus::mem::Move<i32>);
...
TEST(i32, Traits) {
  ...
  static_assert(sus::cmp::StrongOrd<i32, int8_t>);
  static_assert(sus::cmp::StrongOrd<i32, int16_t>);
  static_assert(sus::cmp::StrongOrd<i32, int32_t>);
  static_assert(sus::cmp::StrongOrd<i32, int64_t>);
  static_assert(sus::cmp::StrongOrd<i32, i8>);
  static_assert(sus::cmp::StrongOrd<i32, i16>);
  static_assert(sus::cmp::StrongOrd<i32, i32>);
  static_assert(sus::cmp::StrongOrd<i32, i64>);
  static_assert(sus::cmp::StrongOrd<i32, isize>);
  static_assert(1_i32 >= 1_i32);
  static_assert(2_i32 > 1_i32);
  static_assert(1_i32 <= 1_i32);
  static_assert(1_i32 < 2_i32);
  static_assert(sus::cmp::Eq<i32, int8_t>);
  static_assert(sus::cmp::Eq<i32, int16_t>);
  static_assert(sus::cmp::Eq<i32, int32_t>);
  static_assert(sus::cmp::Eq<i32, int64_t>);
  static_assert(sus::cmp::Eq<i32, i8>);
  static_assert(sus::cmp::Eq<i32, i16>);
  static_assert(sus::cmp::Eq<i32, i32>);
  static_assert(sus::cmp::Eq<i32, i64>);
  static_assert(sus::cmp::Eq<i32, isize>);
  static_assert(1_i32 == 1_i32);
  static_assert(!(1_i32 == 2_i32));
  static_assert(1_i32 != 2_i32);
  static_assert(!(1_i32 != 1_i32));
  ...
  // Verify constexpr.
  [[maybe_unused]] constexpr i32 e = []() {
    i32 a =
        1_i32 + 2_i32 - 3_i32 * 4_i32 / 5_i32 % 6_i32 & 7_i32 | 8_i32 ^ 9_i32;
    [[maybe_unused]] bool b = 2_i32 == 3_i32;
    [[maybe_unused]] std::strong_ordering c = 2_i32 <=> 3_i32;
    [[maybe_unused]] i32 d = a << 1_u32;
    [[maybe_unused]] i32 e = a >> 1_u32;
    a += 1_i32;
    a -= 1_i32;
    a *= 1_i32;
    a /= 1_i32;
...
TEST(i32, CompileTimeConversion) {
  using Self = i32;
  ...
  static_assert(sizeof(i32) >= sizeof(isize) ==
                is_constexpr_convertible<0_isize, Self>(0));
  ...
  static_assert(sizeof(i32) >= sizeof(ptrdiff_t) ==
                is_constexpr_convertible<ptrdiff_t{0}, Self>(0));
  ...
  static_assert(sizeof(i32) >= sizeof(isize) ==
                IsConstexprAssignable<0_isize, Self>);
  ...
  static_assert(sizeof(i32) >= sizeof(isize) ==
                IsConstexprAssignable<ptrdiff_t{0}, Self>);
...
TEST(i32, CompileTimeConversionEnum) {
  using Self = i32;
...
TEST(i32, ToPrimitive) {
  static_assert(NotConvertible<i32, int8_t>);
  static_assert(NotConvertible<i32, int16_t>);
  static_assert(IsImplicitlyConvertible<i32, int32_t>);
  static_assert(IsImplicitlyConvertible<i32, int64_t>);
  static_assert(NotConvertible<i32, uint8_t>);
  static_assert(NotConvertible<i32, uint16_t>);
  static_assert(NotConvertible<i32, uint32_t>);
  static_assert(NotConvertible<i32, uint64_t>);
  static_assert(NotConvertible<i32, size_t>);
}
...
TEST(i32, OperatorsWithPrimitives) {
  static_assert(CanOperator<i32, uint8_t>);
  static_assert(CanOperator<i32, uint16_t>);
  static_assert(CantOperator<i32, uint32_t>);
  static_assert(CantOperator<i32, uint64_t>);

  static_assert(CanOperator<i32, int8_t>);
  static_assert(CanOperator<i32, int16_t>);
  static_assert(CanOperator<i32, int32_t>);
  static_assert(CantOperator<i32, int64_t>);

  static_assert(CanOperator<i32, ENUM(, uint8_t)>);
  static_assert(CanOperator<i32, ENUM(, uint16_t)>);
  static_assert(CantOperator<i32, ENUM(, uint32_t)>);
  static_assert(CantOperator<i32, ENUM(, uint64_t)>);

  static_assert(CanOperator<i32, ENUM(, int8_t)>);
  static_assert(CanOperator<i32, ENUM(, int16_t)>);
  static_assert(CanOperator<i32, ENUM(, int32_t)>);
  static_assert(CantOperator<i32, ENUM(, int64_t)>);

  static_assert(CantOperator<i32, ENUM(class, uint8_t)>);
  static_assert(CantOperator<i32, ENUM(class, uint16_t)>);
  static_assert(CantOperator<i32, ENUM(class, uint32_t)>);
  static_assert(CantOperator<i32, ENUM(class, uint64_t)>);

  static_assert(CantOperator<i32, ENUM(class, int8_t)>);
  static_assert(CantOperator<i32, ENUM(class, int16_t)>);
  static_assert(CantOperator<i32, ENUM(class, int32_t)>);
  static_assert(CantOperator<i32, ENUM(class, int64_t)>);
  ...
  static_assert(CantShift<i32, ENUM(class, uint64_t)>);

  static_assert(CantShift<i32, int8_t>);

  static_assert(CantShift<int8_t, i32>);
  static_assert(CantShift<uint8_t, i32>);
  static_assert(CantShift<ENUM(, int8_t), i32>);
  static_assert(CantShift<ENUM(, uint8_t), i32>);
  static_assert(CantShift<ENUM(class, int8_t), i32>);
  static_assert(CantShift<ENUM(class, uint8_t), i32>);
}

TEST(i32, From) {
  using signed_char = signed char;

  static_assert(sus::construct::From<i32, bool>);
  static_assert(sus::construct::From<i32, signed_char>);
  ...
  static_assert(sus::construct::TryFrom<i32, signed_char>);
  ...
  static_assert(sus::construct::From<i32, ENUM(, signed_char)>);
  static_assert(!sus::construct::From<i32, ENUM(, size_t)>);
  static_assert(sus::construct::From<i32, ENUM(, int8_t)>);
  static_assert(sus::construct::From<i32, ENUM(, int16_t)>);
  static_assert(sus::construct::From<i32, ENUM(, int32_t)>);
  static_assert(!sus::construct::From<i32, ENUM(, int64_t)>);
  static_assert(sus::construct::From<i32, ENUM(, uint8_t)>);
  static_assert(sus::construct::From<i32, ENUM(, uint16_t)>);
  static_assert(!sus::construct::From<i32, ENUM(, uint32_t)>);
  static_assert(!sus::construct::From<i32, ENUM(, uint64_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, signed_char)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, size_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, int8_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, int16_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, int32_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, int64_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, uint8_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, uint16_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, uint32_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(, uint64_t)>);

  static_assert(sus::construct::From<i32, ENUM(class, signed_char)>);
  static_assert(!sus::construct::From<i32, ENUM(class, size_t)>);
  static_assert(sus::construct::From<i32, ENUM(class, int8_t)>);
  static_assert(sus::construct::From<i32, ENUM(class, int16_t)>);
  static_assert(sus::construct::From<i32, ENUM(class, int32_t)>);
  static_assert(!sus::construct::From<i32, ENUM(class, int64_t)>);
  static_assert(sus::construct::From<i32, ENUM(class, uint8_t)>);
  static_assert(sus::construct::From<i32, ENUM(class, uint16_t)>);
  static_assert(!sus::construct::From<i32, ENUM(class, uint32_t)>);
  static_assert(!sus::construct::From<i32, ENUM(class, uint64_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, signed_char)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, size_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, int8_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, int16_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, int32_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, int64_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, uint8_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, uint16_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, uint32_t)>);
  static_assert(sus::construct::TryFrom<i32, ENUM(class, uint64_t)>);
  ...
  EXPECT_EQ(i32::try_from(signed_char{2}).unwrap(), 2_i32);
  ...
  EXPECT_EQ(i32::from(ENUM(, signed_char)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, int8_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, int16_t)::Z), 2_i32);
  EXPECT_EQ(i32::from(ENUM(, int32_t)::Z), 2_i32);

  EXPECT_EQ(i32::try_from(ENUM(, signed_char)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(, size_t)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(, int8_t)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(, int16_t)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(, int32_t)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(, int64_t)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(, uint8_t)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(, uint16_t)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(, uint32_t)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(, uint64_t)::Z).unwrap(), 2_i32);
  EXPECT_EQ(i32::try_from(ENUM(class, uint64_t)::Z).unwrap(), 2_i32);

  EXPECT_TRUE(i32::try_from(ENUM(, int64_t)::MIN).is_err());
  EXPECT_TRUE(i32::try_from(ENUM(, int64_t)::MAX).is_err());
  EXPECT_TRUE(i32::try_from(ENUM(, uint32_t)::MAX).is_err());
  EXPECT_TRUE(i32::try_from(ENUM(, uint64_t)::MAX).is_err());
  EXPECT_TRUE(i32::try_from(ENUM(class, uint64_t)::MAX).is_err());
  ...
  static_assert(!sus::construct::From<i32, uptr>);
  ...
  static_assert(sus::construct::TryFrom<i32, uptr>);
...
TEST(i32, CheckedAbs) {
  ...
  EXPECT_EQ(i32(1234567).checked_abs(), Option<i32>(1234567_i32));
  EXPECT_EQ(i32(-1234567).checked_abs(), Option<i32>(1234567_i32));
  EXPECT_EQ(i32::MAX.checked_abs(), Option<i32>(i32::MAX));
  EXPECT_EQ((i32::MIN + 1_i32).checked_abs(), Option<i32>(i32::MAX));
  EXPECT_EQ(i32::MIN.checked_abs(), None);

  // lvalue.
  auto i = -9000_i32;
  EXPECT_EQ(i.checked_abs(), Option<i32>(9000_i32));
}
...
TEST(i32, OverflowingAbs) {
  ...
  EXPECT_EQ(i32(-1234567).overflowing_abs(),
            (Tuple<i32, bool>(1234567_i32, false)));
  EXPECT_EQ(i32::MAX.overflowing_abs(), (Tuple<i32, bool>(i32::MAX, false)));
  EXPECT_EQ((i32::MIN + 1_i32).overflowing_abs(),
            (Tuple<i32, bool>(i32::MAX, false)));
  EXPECT_EQ((i32::MIN).overflowing_abs(), (Tuple<i32, bool>(i32::MIN, true)));
...
TEST(i32, OverflowingAdd) {
  ...
  EXPECT_EQ((0_i32).overflowing_add(0_i32), (Tuple<i32, bool>(0_i32, false)));
...
TEST(i32, CheckedDiv) {
  ...
  EXPECT_EQ((0_i32).checked_div(123_i32), Option<i32>(0_i32));
  EXPECT_EQ((2345_i32).checked_div(1_i32), Option<i32>(2345_i32));
...
TEST(i32, OverflowingDiv) {
  ...
  EXPECT_EQ((0_i32).overflowing_div(123_i32), (Tuple<i32, bool>(0_i32, false)));
...
TEST(i32, CheckedNeg) {
  ...
  EXPECT_EQ(a, Option<i32>(0_i32));

  EXPECT_EQ((0_i32).checked_neg(), Option<i32>(0_i32));
  ...
  EXPECT_EQ(b, Option<i32>(-123456_i32));
  EXPECT_EQ(i32::MIN.checked_neg(), None);
  EXPECT_EQ(i32::MAX.checked_neg(), Option<i32>(i32::MIN + i32(1)));
  EXPECT_EQ((20_i32).checked_neg(), Option<i32>(-20_i32));
}
...
TEST(i32, OverflowingNeg) {
  ...
  // ** Signed only.
  EXPECT_EQ(i32::MIN.overflowing_neg(), (Tuple<i32, bool>(i32::MIN, true)));
  EXPECT_EQ(i32::MAX.overflowing_neg(),
            (Tuple<i32, bool>(i32::MIN + i32(1), false)));
  EXPECT_EQ((20_i32).overflowing_neg(), (Tuple<i32, bool>(-20_i32, false)));
}
...
TEST(i32, CheckedRem) {
  ...
  EXPECT_EQ(a, Option<i32>(2_i32));

  EXPECT_EQ((0_i32).checked_rem(123_i32), Option<i32>(0_i32));
  EXPECT_EQ((2345_i32).checked_rem(4_i32), Option<i32>(1_i32));
...
TEST(i32, OverflowingRem) {
  ...
  EXPECT_EQ((0_i32).overflowing_rem(123_i32), (Tuple<i32, bool>(0_i32, false)));
  ...
  EXPECT_EQ((-2345_i32).overflowing_rem(4_i32),
            (Tuple<i32, bool>(-1_i32, false)));
  EXPECT_EQ(i32::MIN.overflowing_rem(-1_i32), (Tuple<i32, bool>(0_i32, true)));
}
...
TEST(i32, OverflowingShl) {
  ...
  EXPECT_EQ((2_i32).overflowing_shl(1_u32), (Tuple<i32, bool>(4_i32, false)));

  // Masks out everything.
  EXPECT_EQ((2_i32).overflowing_shl(32_u32), (Tuple<i32, bool>(2_i32, true)));
  // Masks out everything but the 1.
  EXPECT_EQ((2_i32).overflowing_shl(33_u32), (Tuple<i32, bool>(4_i32, true)));
...
TEST(i32, CheckedShl) {
  ...
  EXPECT_EQ(a, Option<i32>(10_i32));

  EXPECT_EQ((2_i32).checked_shl(1_u32), Option<i32>(4_i32));
...
TEST(i32, CheckedShr) {
  ...
  EXPECT_EQ((4_i32).checked_shr(1_u32), Option<i32>(2_i32));
...
TEST(i32, OverflowingShr) {
  ...
  EXPECT_EQ((4_i32).overflowing_shr(1_u32), (Tuple<i32, bool>(2_i32, false)));

  // Masks out everything.
  EXPECT_EQ((4_i32).overflowing_shr(32_u32), (Tuple<i32, bool>(4_i32, true)));
  // Masks out everything but the 1.
...
TEST(i32, OverflowingSub) {
  ...
  EXPECT_EQ((0_i32).overflowing_sub(0_i32), (Tuple<i32, bool>(0_i32, false)));
...
TEST(i32, OverflowingPow) {
  ...
  EXPECT_EQ((2_i32).overflowing_pow(5_u32), (Tuple<i32, bool>(32_i32, false)));
  EXPECT_EQ((2_i32).overflowing_pow(0_u32), (Tuple<i32, bool>(1_i32, false)));
  EXPECT_EQ((i32::MAX).overflowing_pow(1_u32),
            (Tuple<i32, bool>(i32::MAX, false)));
  EXPECT_EQ((i32::MAX).overflowing_pow(2_u32), (Tuple<i32, bool>(1_i32, true)));
}

TEST(i32, CheckedPow) {
  constexpr auto a = (2_i32).checked_pow(5_u32);
  EXPECT_EQ(a, Option<i32>(32_i32));

  EXPECT_EQ((2_i32).checked_pow(5_u32), Option<i32>(32_i32));
  EXPECT_EQ((2_i32).checked_pow(0_u32), Option<i32>(1_i32));
  EXPECT_EQ((2_i32).checked_pow(1_u32), Option<i32>(2_i32));
  EXPECT_EQ((2_i32).checked_pow(30_u32), Option<i32>(1_i32 << 30_u32));
  EXPECT_EQ((1_i32).checked_pow(u32::MAX), Option<i32>(1_i32));
  EXPECT_EQ((i32::MAX).checked_pow(1_u32), Option<i32>(i32::MAX));
  EXPECT_EQ((i32::MAX).checked_pow(0_u32), Option<i32>(1_i32));
...
TEST(i32, ReverseBits) {
  ...
  EXPECT_EQ(a5, 1_i32 << (sus::cast<u32>(sizeof(i32)) * 8_u32 - 1_u32));
  ...
  EXPECT_EQ((i32(1)).reverse_bits().primitive_value,
            1_i32 << (sus::cast<u32>(sizeof(i32)) * 8_u32 - 1_u32));
}
...
TEST(i32, CheckedLog2) {
  ...
  EXPECT_EQ((2_i32).checked_log2(), Option<u32>(1_u32));
  EXPECT_EQ((55555_i32).checked_log2(), Option<u32>(15_u32));
  ...
  // ** Signed only.
  EXPECT_EQ((i32::MAX).checked_log2(), Option<u32>(30_u32));
...
TEST(i32, CheckedLog10) {
  ...
  EXPECT_EQ((2_i32).checked_log10(), Option<u32>(0_u32));
  EXPECT_EQ((55555_i32).checked_log10(), Option<u32>(4_u32));
  EXPECT_EQ((i32::MAX).checked_log10(), Option<u32>(9_u32));
...
TEST(i32, CheckedLog) {
  ...
  EXPECT_EQ((2_i32).checked_log(10_i32), Option<u32>(0_u32));
  EXPECT_EQ((55555_i32).checked_log(10_i32), Option<u32>(4_u32));
  EXPECT_EQ(i32::MAX.checked_log(10_i32), Option<u32>(9_u32));
...
TEST(i32, CheckedAddUnsigned) {
  ...
  EXPECT_EQ((-1_i32).checked_add_unsigned(2u), Option<i32>(1_i32));
  EXPECT_EQ((i32::MIN).checked_add_unsigned(u32::MAX), Option<i32>(i32::MAX));
...
TEST(i32, CheckedSubUnsigned) {
  ...
  EXPECT_EQ((-1_i32).checked_sub_unsigned(2u), Option<i32>(-3_i32));
  EXPECT_EQ((i32::MAX).checked_sub_unsigned(u32::MAX), Option<i32>(i32::MIN));
...
TEST(i32, CheckedDivEuclid) {
  ...
  EXPECT_EQ(a, Option<i32>(1_i32));

  EXPECT_EQ((7_i32).checked_div_euclid(4_i32), Option<i32>(1_i32));
...
TEST(i32, CheckedRemEuclid) {
  ...
  EXPECT_EQ(a, Option<i32>(3_i32));

  EXPECT_EQ((7_i32).checked_rem_euclid(4_i32), Option<i32>(3_i32));
