...
TEST(i16, Traits) {
  ...
  // Verify constexpr.
  [[maybe_unused]] constexpr i16 e = []() {
    i16 a =
        1_i16 + 2_i16 - 3_i16 * 4_i16 / 5_i16 % 6_i16 & 7_i16 | 8_i16 ^ 9_i16;
    [[maybe_unused]] bool b = 2_i16 == 3_i16;
    [[maybe_unused]] std::strong_ordering c = 2_i16 <=> 3_i16;
    [[maybe_unused]] i16 d = a << 1_u32;
    [[maybe_unused]] i16 e = a >> 1_u32;
    a += 1_i16;
    a -= 1_i16;
    a *= 1_i16;
    a /= 1_i16;
...
TEST(i16, ToPrimitive) {
  ...
  static_assert(IsImplicitlyConvertible<i16, int16_t>);
  static_assert(IsImplicitlyConvertible<i16, int32_t>);
  static_assert(IsImplicitlyConvertible<i16, int64_t>);
...
TEST(i16, OperatorsWithPrimitives) {
  static_assert(CanOperator<i16, uint8_t>);
  static_assert(CantOperator<i16, uint16_t>);
  static_assert(CantOperator<i16, uint32_t>);
  static_assert(CantOperator<i16, uint64_t>);

  static_assert(CanOperator<i16, int8_t>);
  static_assert(CanOperator<i16, int16_t>);
  static_assert(CantOperator<i16, int32_t>);
  static_assert(CantOperator<i16, int64_t>);

  static_assert(CanOperator<i16, ENUM(, uint8_t)>);
  static_assert(CantOperator<i16, ENUM(, uint16_t)>);
  static_assert(CantOperator<i16, ENUM(, uint32_t)>);
  static_assert(CantOperator<i16, ENUM(, uint64_t)>);

  static_assert(CanOperator<i16, ENUM(, int8_t)>);
  static_assert(CanOperator<i16, ENUM(, int16_t)>);
  static_assert(CantOperator<i16, ENUM(, int32_t)>);
  static_assert(CantOperator<i16, ENUM(, int64_t)>);

  static_assert(CantOperator<i16, ENUM(class, uint8_t)>);
  static_assert(CantOperator<i16, ENUM(class, uint16_t)>);
  static_assert(CantOperator<i16, ENUM(class, uint32_t)>);
  static_assert(CantOperator<i16, ENUM(class, uint64_t)>);

  static_assert(CantOperator<i16, ENUM(class, int8_t)>);
  static_assert(CantOperator<i16, ENUM(class, int16_t)>);
  static_assert(CantOperator<i16, ENUM(class, int32_t)>);
  static_assert(CantOperator<i16, ENUM(class, int64_t)>);
  ...
  static_assert(CantShift<i16, ENUM(class, uint64_t)>);

  static_assert(CantShift<i16, int8_t>);

  static_assert(CantShift<int8_t, i16>);
  static_assert(CantShift<uint8_t, i16>);
  static_assert(CantShift<ENUM(, int8_t), i16>);
  static_assert(CantShift<ENUM(, uint8_t), i16>);
  static_assert(CantShift<ENUM(class, int8_t), i16>);
  static_assert(CantShift<ENUM(class, uint8_t), i16>);
}
