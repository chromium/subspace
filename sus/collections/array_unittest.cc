...
static_assert(sus::iter::DoubleEndedIterator<
              sus::collections::ArrayIntoIter<i32, 3>, i32>);
static_assert(
    sus::iter::ExactSizeIterator<sus::collections::ArrayIntoIter<i32, 0>, i32>);
static_assert(
...
TEST(Array, Clone) {
  ...
  static_assert(::sus::mem::CloneFrom<Array<Copy, 1>>);
  ...
  static_assert(::sus::mem::CloneFrom<Array<Clone, 1>>);
